            ...
            <div class="well-container">
              <?php echo form_open_multipart("form/do_uploads", array("id" => "FormDocs", "name" => "FormDocs", "class" => "form-horizontal")); ?>
                <fieldset>
                  ...
                  <div class="form-group">
                    <label for="TxtFileLawyer" class="col-sm-3 control-label">Poder de Abogado</label>
                    <div class="col-sm-4">
                  ...
                  <div class="form-group">
                    <label for="TxtFileCertifieds" class="col-sm-3 control-label">Certificaciones Laborales</label>
                    <div class="col-sm-4">
                  ...
                  <div class="form-group">
                    <label for="TxtFileAutorize" class="col-sm-3 control-label">Autorización de Entidiades</label>
                    <div class="col-sm-4">
                  ...
                  <div class="form-group">
                    <label for="TxtFileThirdParty" class="col-sm-3 control-label">Certificaciones de Terceros</label>
                    <div class="col-sm-4">
                  ...
                  <div class="form-group">
                    <label for="TxtFileCommercial" class="col-sm-3 control-label">Certificaciones Comerciales</label>
                    <div class="col-sm-4">
                  ...
                  <div class="form-group">
                    <label for="TxtFileInvoices" class="col-sm-3 control-label">Facturas - Recibos</label>
                    <div class="col-sm-4">
                  ...
                  <div class="form-group">
                    <label for="TxtFileNeighbor" class="col-sm-3 control-label">Certificaciones de Vecindad</label>
                    <div class="col-sm-4">
                  ...
                  <div class="form-group">
                    <label for="TxtFilePQR" class="col-sm-3 control-label">Derechos de Petición a Entidades de Control</label>
                    <div class="col-sm-4">
                  ...
                  <div class="form-group">
                    <label for="TxtFileEmgesa" class="col-sm-3 control-label">Radicados Emgesa</label>
                    <div class="col-sm-4">
                  ...
                  <div class="form-group">
                    <label for="TxtFileOthers" class="col-sm-3 control-label">Otros</label>
                    <div class="col-sm-4">
